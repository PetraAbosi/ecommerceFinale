    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
        	<a href="about.html"> <img class="first-slide" src="../images/teni.jpg" alt="First slide">
			<div>
        ...
        <div class="item">
         <a href="leather_bag.php"> <img class="second-slide " src="../images/banner3.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
          <a href="unrefined_shea.php"><img class="third-slide " src="../images/banner2.jpg" alt="Third slide"></a>
